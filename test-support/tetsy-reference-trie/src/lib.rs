...
pub type RefTrieDBMutAllowEmpty<'a> = tetsy_trie_db::TrieDBMut<'a, AllowEmptyLayout>;
...
pub fn reference_trie_root_no_extension<I, A, B>(input: I) -> <KeccakHasher as Hasher>::Out where
	...
	B: AsRef<[u8]> + fmt::Debug,
{
	tetsy_trie_root::trie_root_no_extension::<KeccakHasher, ReferenceTrieStreamNoExt, _, _, _>(input)
}
